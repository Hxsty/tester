...
onStartGameType()
{
	...
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 600 );
	}
	
	else if ( getDvar( "expp" ) == "2" )
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 700 );
	}
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "plant", 1000 );
	maps\mp\gametypes\_rank::registerScoreInfo( "longshot", 50 );
	maps\mp\gametypes\_rank::registerScoreInfo( "defuse", 1000 );
