...
longshot( killId )
{
	...
	if ( getDvar( "expp" ) == "0" )
	{
	if(self.modifiers["longshot"] == true)
	{
	if (self.modifiers["headshot"] == false)
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 550 );
	}
	else
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 1050 );
	}
	}
	}
	...
	if (self.modifiers["headshot"] == false)
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 650 );
	}
	else
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 1150 );
	}
	}
	}
	...
	if (self.modifiers["headshot"] == false)
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 750 );
	}
	else
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 1250 );
	}
	}
	}
	...
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 150 );
	}
	}
	}
...
headShot( killId )
{
	...
	if (self.modifiers["headshot"] == true)
	{
	...
	if (self.modifiers["headshot"] == true)
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 1100 );
	}
	}
	...
	if (self.modifiers["headshot"] == true)
	{
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 1200 );
	}
	}
